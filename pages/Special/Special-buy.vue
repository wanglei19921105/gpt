<template>
	<view class="page" :class="getThemeClass">
		...
		<!-- 订单信息 -->
		<orderInfo :infoData="pay" :zhuanqu="zhuanqu" :one="1" @change="numchange"></orderInfo>
		<!-- 支付方式 -->
...
export default {
	...
	methods: {
		...
		payBtn() {
			...
			this.$u.api.vip_sale_order_add(data).then(res => {
				if (res.code == 200) {
