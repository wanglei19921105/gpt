...
<!--		<view class="gap-100"></view>-->
    ...
    <view class="ListBox WidthGlobal1 MarginAuto">
      <view v-for="(item,index) in list" :key="index" @click="$u.route('/pages/Special/SpecialDetailsNewOrderlogLog?id=' + item.id)" class="Unit MarginT_30rpx PaddingT_32rpx PaddingB_32rpx Width100 BorderR_20rpx">
